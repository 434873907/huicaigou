...
<!--      <div class="btn-fill-org-main base-margin-bottom" @click="addData()">添加一个背景图</div>-->
      <div style="display: flex;align-items: center">
        <div class="btn-fill-org-main base-margin-bottom" @click="addData()">添加一个背景图</div>
        <div class="tips">(尺寸建议为560x320px，大小不超过1M)</div>
      </div>
      <div class="blue-wrap" v-for="(item,index) in formData.styleAndData.imageList" :key="index + 'No'">
        ...
        <div class="img-wrap inline-block">
          ...
          <upload :index="index"  v-on:uploadSuccess="uploadSuccess" :options="{radio:1.75}" class="link underline">更换图片</upload>
        </div>
        <div class="form-content inline-block">
          ...
          <!-- <div class="form-wrap" v-show="item.jump.jumpType == 26">
...
export default {
  ...
  methods:{
    ...
    save(){
      ...
      const {styleAndData: {imageList}} = this.formData
