...
/**
 * @author 月汐
 * @date 2018/10/22 20:30
 */
public class QueryAnnouncementBO extends JsonPojo {
    ...
    public static QueryAnnouncementBO convert(AnnouncementDO announcementDO) {
        QueryAnnouncementBO bo = new QueryAnnouncementBO();
