 ...
 **/
public class QuerySupplierOrderListController extends AbstractApiController<QuerySupplierOrderListForm> {
    ...
    protected Result<?> doBiz(HttpServletRequest request, HttpServletResponse response, QuerySupplierOrderListForm command) throws Exception {
        ...
        searchParam.setExpressStatus(command.getStatus().getCode());
